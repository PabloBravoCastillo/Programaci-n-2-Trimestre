...
public class Principal {
	public static void main(String[] args) {
		...
		int numEquipos;
		System.out.println("Introduce el n�mero de equipos que quieres que tenga la liga: ");
		...
		while(opcion!=10) {
			limpiarPantalla();
			imprimirMenu();
			System.out.println("Introduce la opci�n que quieras: ");
			opcion=leerEntrada();
			switch(opcion) {
			case 1: 
			// Avanzar Jornadas    //
...
//		}
	...
	System.out.println("2-Mostrar Clasificaci�n");
